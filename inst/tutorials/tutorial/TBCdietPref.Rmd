...
## Figure 2
### Figure 2
```{r Fig2, exercise=T, warning = F, message = F, eval = F, exercise.timelimit = 1000000,fig.height=10, fig.width=3.5}
...
```{r MGWA, exercise=T, warning = F, message = F, eval = F,  exercise.timelimit = 1000000}
...
## Figure 3
```{r fig3, exercise=T, warning = F, message = F, eval = F, fig.width = 5, exercise.timelimit = 10000 }
...
## Figure S3
code below does not execute because cannot post Walters 2020 data to GitHub; but if user reads it in after downloading from Molecular Ecology (file name and sheet are shown in code), subsequent code will work
