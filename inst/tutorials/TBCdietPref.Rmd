...
## 100g100y
```{r PLOTTED 10g10y v 10g10y}

aaa <- read_xls('DataInExcelFormat 100.100 vs 100.00 +Date.xls', sheet = "NumberOfSips")
abb <- read_xls('DataInExcelFormat 100.100 vs 100.00 +Date.xls', sheet = "Date")
aab <- read_xls('DataInExcelFormat 100.100 vs 100.00 +Date.xls', sheet = "Date")
ccc <- aaa
...
write.table(pd2, "figure1_rawdata.csv", append = F)
...
## 75y100g
```{r PLOTTED 7.5y10g v 10g10y}

aaa <- read_xls('DataInExcelFormat 100g75y +Date.xls', sheet = "NumberOfSips")
abb <- read_xls('DataInExcelFormat 100g75y +Date.xls', sheet = "Date")
aab <- read_xls('DataInExcelFormat 100g75y +Date.xls', sheet = "Date")
ccc <- aaa
...
## 50g100y
```{r PLOTTED 5g10y v 10g10y}

aaa <- read_xls('DataInExcelFormat 50g100y +Date.xls', sheet = "NumberOfSips")
abb <- read_xls('DataInExcelFormat 50g100y +Date.xls', sheet = "Date")
aab <- read_xls('DataInExcelFormat 50g100y +Date.xls', sheet = "Date")
ccc <- aaa
